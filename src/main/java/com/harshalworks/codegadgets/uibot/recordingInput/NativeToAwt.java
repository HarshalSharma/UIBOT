...
public class NativeToAwt {

    public static int getAwtKeyCode(NativeKeyEvent e) {
...
//                break;
    ...
    public static int getAwtModifiers(NativeKeyEvent e) {
        int modifiers = 0x00;
    ...
    public static int getAwtKeyLocation(NativeKeyEvent e) {
